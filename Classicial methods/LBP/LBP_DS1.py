'''
LBP facial recognition of the first dataset (AT&T)
'''
...
lbp_recognition(train_dataset_path=train_path, test_dataset_path=test_path, knn=1, tatal_tr_imgs=280, total_tst_imgs=120,
                 train_img_nbr_class=7, tst_img_nbr_class=3, raduis=1, n_points=8)