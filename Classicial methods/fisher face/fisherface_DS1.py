...
def fisherFace(train_dataset_path, test_dataset_path, knn, total_tr_imgs, total_tst_imgs, train_img_nbr_class, tst_img_nbr_class):
    # for train -------------------------------------------------------------------------------
    ...
    if accuracy_new[0][0] == 0:
        print('accuracy (K = ', knn, ')', 1 - (accuracy_new[0][1] / total_tst_imgs))
    else:
        print('accuracy (K = ', knn, ')', accuracy_new[0][1] / total_tst_imgs)
...
fisherFace(train_dataset_path=train_path, test_dataset_path=test_path, knn=1, total_tr_imgs=280, 
