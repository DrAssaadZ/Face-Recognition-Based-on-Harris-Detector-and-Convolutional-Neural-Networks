...
def eigen_face(train_dataset_path, test_dataset_path, nb_component, knn, total_tr_imgs, total_tst_imgs, train_img_nbr_class, tst_img_nbr_class):
    # for train -------------------------------------------------------------------------------
    ...
    # used only to save the mean face
    # display_mean_face = np.reshape(np.array(train_mean_face_vect) * 255, (112, 92))
    # cv.imwrite('new_face.jpg', display_mean_face)
    ...
    if accuracy_new[0][0] == 0:
        print('accuracy (', nb_component, ',', knn, ') = ', 1 - (accuracy_new[0][1] / total_tst_imgs))
    else:
        print('accuracy (', nb_component, ',', knn, ') = ', accuracy_new[0][1] / total_tst_imgs)

    
# main ----------------------------------------------------------

train_path = '../../datasets/dataset1/orig_images/training/'
test_path = '../../datasets/dataset1/orig_images/testing/'



eigen_face(train_dataset_path=train_path, test_dataset_path=test_path, nb_component=70, knn=1, total_tr_imgs=280,
           total_tst_imgs=120, train_img_nbr_class=7, tst_img_nbr_class=3)
